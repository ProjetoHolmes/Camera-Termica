Window.fonts[0].set_bold(True)
    ...
    def _init_(self, thermal_image=None, filename=None):
         for the main window.
        ...
        self.managers["main"] = Manager(
            buttons=[
                ((15, 15), (215, 45), "marcação", lambda: self.changeMode("spot")),
                (
                    (15, 75),
                    (215, 45),
                    "Line measurement",
                ...
                ((15, 530), (100, 45), "abrir imagem" lambda: self.work("open")),
        ...
        self.managers["emissivity"] = Manager(
            ...
            textbox=(
                ...
                "Clique para selecionar a região",
            ),
            fields=[
    ...
    def work(self, mode, *args):
            ...
            self.overlays = pygame.Surface((WINDOSIZE[0] - 245, 512), pygame.SRCALPHA)
            self.lineNum = 0
            self.boxNum = 0
            self.spotNum = 0
